...
const Hero = () => {
  return (
    <main className="h-max relative pt-20 pb-24">
      <div className="mx-auto size-max flex flex-col items-center gap-12">
        ...
        <div className="space-y-6">
          <div className="text-[5rem] leading-[5rem] text-mytext font-main font-semibold max-w-[900px] text-center">
            One tool to{' '}
          ...
          <p className="text-xl text-myaccent font-default font-medium  max-w-[900px] text-center">
        ...
        <div className="flex items-center gap-6 mx-auto text-center">
          <Button
            variant={'default'}
            size={'lg'}
