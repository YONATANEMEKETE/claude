...
const Integrations = () => {
  return (
    <div className="relative max-w-[1400px] min-[1400px]:mx-auto mt-28 mx-4  min-h-[110vh] bg-myfooterbg rounded-2xl overflow-clip">
      ...
      <div className="absolute z-20 inset-0  rounded-2xl pt-20">
        <div className="size-max mx-auto flex flex-col items-center gap-10 mb-12">
          ...
          <div className="space-y-4 text-center">
            <div className="text-5xl text-white font-default font-semibold max-w-[700px]">
              Dont Replace. Integrate.
            </div>
            <p className="text-base text-white font-default max-w-[700px]">
